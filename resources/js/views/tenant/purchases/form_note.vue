            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row" v-if="form.items.length > 0">
                        ...
                        <div class="col-md-12">
                            <h3 class="text-right" v-if="form.total > 0"><b>TOTAL COMPRAS: </b>{{ getFormatDecimal(ratePrefix()) }} {{
                                form.total }}</h3>
                            ...
                            <template v-if="is_perception_agent">
                                ...
                                <h3 class="text-right" v-if="form.total > 0 && !hide_button"><b>MONTO TOTAL : </b>{{ getFormatDecimal(ratePrefix()) }} {{ total_amount }}</h3>
