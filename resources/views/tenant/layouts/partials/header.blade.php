                ...
                <ul class="list-unstyled mb-2">
                    ...
                    <li>
                        ...
                        <a role="menuitem" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                           <span class="material-symbols-outlined">logout</span> @lang('app.buttons.logout')
                        </a>
...
<div id="supportSidebar" class="support-sidebar">
    ...
    <p><strong>Email:</strong>erpnuvo@gmail.com<a class="support-link" href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $user->address_contact }}" target="_blank">{{ $user->address_contact }}</a></p>
    <p><strong>Teléfono:</strong>3124567893<a class="support-link" href="https://wa.me/{{ $user->phone }}" target="_blank">{{ $user->phone }}</a></p>
    </div>
</div>
