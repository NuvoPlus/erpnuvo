    ...
    export default {
        ...
        methods: {
            ...
            getPricePerExtraHour(percentage){
                // obtener el precio por hora, incluido el % agregado al ser hora extra --- 30d * 7.8333333 = 230
                return (parseFloat(this.form.accrued.total_base_salary) / 230) * (1 + percentage / 100)
            },
